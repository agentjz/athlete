...
import {
  rebuildExecutionSchemaWithoutInline,
  rebuildExecutionSchemaWithDreamingProfile,
  rebuildExecutionSchemaWithWorkflowProfile,
} from "./executionMigration.js";
import { addMissingExecutionColumns, createExecutionSchema } from "./executionSchema.js";
...
function addExecutionWaitPolicyColumn(db: Database.Database): void {
  addMissingExecutionColumns(db, [["wait_policy_json", "TEXT"]]);
}
