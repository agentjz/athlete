      ...
      output: JSON.stringify(
        {
          ...
          hint: `The arguments for ${toolName} were malformed. Re-read the tool schema and retry with valid JSON arguments.`,
          next_step: "Fix the JSON arguments before retrying the tool call.",
        },
        null,
        2,
      ),
