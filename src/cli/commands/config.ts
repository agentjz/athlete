        ...
        JSON.stringify(
          {
            ...
            runtimeBudget: {
              ...
              yieldAfterToolSteps: runtime.config.yieldAfterToolSteps,
              maxToolIterations: runtime.config.maxToolIterations,
              maxContinuationBatches: runtime.config.maxContinuationBatches,
              managedTurnMaxSlices: runtime.config.managedTurnMaxSlices,
              managedTurnMaxElapsedMs: runtime.config.managedTurnMaxElapsedMs,
            },
