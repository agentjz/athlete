...
optional_tools: mcp_playwright_browser_click, mcp_playwright_browser_type, mcp_playwright_browser_take_screenshot
...
5. If the page cannot be driven through MCP, explain the failure and only then consider a non-browser fallback.
